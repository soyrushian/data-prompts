...
# Clona tu fork
git clone https://github.com/soyrushian/data-prompts.git
cd data-prompts
...
1. Abre un [Issue](https://github.com/soyrushian/data-prompts/issues)
2. Incluye:
   - Nombre del prompt
   - IA utilizada
   - Problema encontrado
...
- Abre un [Issue](https://github.com/soyrushian/data-prompts/issues) con tu pregunta
